...
plt.scatter(tdata, cac_kd_concentration, label = 'Cactus KD', color='tomato')
plt.errorbar(tdata, cac_kd_concentration, yerr = cac_kd_std_dev, color='tomato')
plt.scatter(tdata, cac_ctrl_concentration, label = 'MalE ctrl', color='dodgerblue')
plt.errorbar(tdata, cac_ctrl_concentration, yerr = cac_ctrl_std_dev, color='dodgerblue')
...
plt.scatter(tdata, cec2_kd_concentration, label = 'Cactus KD', color='tomato')
plt.errorbar(tdata, cec2_kd_concentration, yerr = cec2_kd_std_dev, color='tomato')
plt.scatter(tdata, cec2_ctrl_concentration, label = 'MalE ctrl', color='dodgerblue')
plt.errorbar(tdata, cec2_ctrl_concentration, yerr = cec2_ctrl_std_dev, color='dodgerblue')
plt.xlabel('Hours post infection')
...
plt.scatter(tdata, def2_kd_concentration, label = 'Cactus KD', color='tomato')
plt.errorbar(tdata, def2_kd_concentration, yerr = def2_kd_std_dev, color='tomato')
plt.scatter(tdata, def2_ctrl_concentration, label = 'MalE ctrl', color='dodgerblue')
plt.errorbar(tdata, def2_ctrl_concentration, yerr = def2_ctrl_std_dev, color='dodgerblue')
plt.xlabel('Hours post infection')
...
plt.scatter(tdata, def3_kd_concentration, label = 'Cactus KD', color='tomato')
plt.errorbar(tdata, def3_kd_concentration, yerr = def3_kd_std_dev, color='tomato')
plt.scatter(tdata, def3_ctrl_concentration, label = 'MalE ctrl', color='dodgerblue')
plt.errorbar(tdata, def3_ctrl_concentration, yerr = def3_ctrl_std_dev, color='dodgerblue')
plt.xlabel('Hours post infection')
...
plt.scatter(tdata, ctrl_concentration, label = 'MalE control data', color='dodgerblue')
plt.plot(taxis, A_ctrl_fit, label='and model fit', color='dodgerblue')

plt.scatter(tdata, kd_concentration, label = 'Cactus RNAi data', color='red')
plt.plot(taxis, A_kd_fit, label='and model fit', color='red')
